...
var Html5Qrcode = function () {
    ...
    return _createClass(a, [{
        ...
        value: function (b, c, d, e) {
            ...
            if (j.style.position = "relative", this._shouldScan = !0, this._element = j, this.qrcode.callback = d, i) { var l = h.qrbox; if (l < a.MIN_QR_BOX_SIZE) throw "minimum size of 'config.qrbox' is" + " ".concat(a.MIN_QR_BOX_SIZE, "px."); if (l > k) throw "'config.qrbox' should not be greater than the width of the HTML element." }
            var m = function (a, b) {
                var c = h.qrbox;
            ...
            return new Promise(function (a, c) {
                if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                    ...
                    navigator.mediaDevices.getUserMedia({ audio: !1, video: d }).then(function (b) { p(b).then(function () { g._isScanning = !0, a() })["catch"](c) })["catch"](function (a) { c("Error getting userMedia, error = ".concat(a)) })
                    ...
                    navigator.getUserMedia({ video: { optional: [{ sourceId: b }] } }, function (b) { p(b).then(function () { g._isScanning = !0, a() })["catch"](c) }, function (a) { c("Error getting userMedia, error = ".concat(a)) })
...
var Html5QrcodeScanner = function () {
    ...
    return _createClass(a, [{
        ...
        value: function () {
            ...
            g.innerHTML = "Request Camera Permissions", g.id = "btnReqCam",
            ...
            j.innerHTML = "&nbsp; Select Image", h.appendChild(i), h.appendChild(j), i.addEventListener("change", function (c) {
                if (b.currentScanType === a.SCAN_TYPE_FILE && 0 != c.target.files.length) {
                    ...
                    b.html5Qrcode.scanFile(d, !0).then(function (a) { b.__resetHeaderMessage(), b.qrCodeSuccessCallback(a) })["catch"](function (c) { b.__setStatus("ERROR", a.STATUS_WARNING), b.__setHeaderMessage(c, a.STATUS_WARNING) })
                }
            })
        }
    }, {
        ...
        value: function (b) {
            ...
            e.innerHTML = "Pakai Kamera (".concat(b.length, ") &nbsp;"), e.style.marginRight = "10px";
            ...
            n.innerHTML = "Mulai Scan", n.id = "btnStartScan", m.appendChild(n);

            var o = document.createElement("button");
            o.innerHTML = "Stop Scanning", o.className = "btn btn-default", o.style.display = "none", o.disabled = !0, m.appendChild(o), d.appendChild(m), n.addEventListener("click", function () {
        ...
        value: function () {
            var b = this,
                c = "Scan dari Image File",
                d = "Scan Dengan Kamera",
